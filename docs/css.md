...
/* .mtk6 {
  color: #ed34fe;
  text-shadow: 0 0 1px #001716, 0 0 1px #03edf950, 0 0 2px #03edf950, 0 0 3px #03edf950;
} */

.mtk7 {
    color: #fff5f6;
    text-shadow: 0 0 1px #000, 0 0 4px #88888875, 0 0 2px #88888875,
        0 0 8px #88888875;
}
...
.mtk16 {
    color: rgb(221, 221, 86);
    text-shadow: 0 0 1px #393a33, 0 0 3px #f39f0575, 0 0 1px #f39f0575;
}
...
.mtk18 {
    color: #ed34fe;
    text-shadow: 0 0 1px #001716, 0 0 1px #03edf950, 0 0 2px #03edf950,
        0 0 3px #03edf950;
}
...
.monaco-workbench
    ...
    .action-item
    .action-label {
    color: rgb(167, 255, 205) !important;
    text-shadow: 0 0 2px #393a33, 0 0 8px #2d8fd0, 0 0 12px #3c9ad6,
        0 0 15px #4aa4db75 !important;
}
...
.monaco-workbench
    ...
    > .title
    .editor-actions {
    filter: drop-shadow(0 0 3px rgba(114, 192, 255, 0.7));
    text-shadow: 0 0 2px #393a33, 0 0 8px #2196f3, 0 0 12px #0d8bf7,
        0 0 15px #0a74d3 !important;
}
...
.monaco-workbench
    ...
    > .monaco-action-bar
    .action-label {
    color: #4886f9da !important;
    text-shadow: 0 0 1px #30cccc, 0 0 4px #88888875, 0 0 2px #88888875,
        0 0 8px #88888875 !important;
    transition: all 0.3s ease;
}

/* 右下角X按钮 */
.codicon-panel-close:before {
    color: rgba(253, 40, 40, 0.764);
    text-shadow: 0 0 8px rgba(253, 40, 40, 0.764),
        0 0 12px rgba(253, 40, 40, 0.5);
    filter: drop-shadow(0 0 8px rgba(253, 40, 40, 0.764));
}

/* copilot */
.codicon-copilot:before {
    color: #ffd700;
    text-shadow: 0 0 2px #393a33, 0 0 8px #ffd700, 0 0 12px #ffd700,
        0 0 15px #ffd70075;
...
/* 滚动条 */
/* .slider  {
  background: linear-gradient(to bottom, rgba(255, 0, 0, 0.5), rgba(255, 165, 0, 0.5), rgba(255, 255, 0, 0.5), rgba(0, 128, 0, 0.5), rgba(0, 0, 255, 0.5), rgba(75, 0, 130, 0.5), rgba(238, 130, 238, 0.5)) !important;
...
div:nth-of-type(3)
    ...
    > div.vertical
    > div {
    filter: drop-shadow(0 0 5px #28b2b9bd) !important;
    background: linear-gradient(to bottom, #1ae72b, #03edf9) !important;
...
div.monaco-grid-view
    ...
    > div {
    filter: drop-shadow(0 0 5px #28b2b9bd) !important;
    background: linear-gradient(to bottom, #e7e41a, #f903f9) !important;
    opacity: 0.3 !important;
    border-radius: 10px;
}
...
/* 左上角菜单 */
.menubar-menu-title {
    color: #f939b6 !important;
    text-shadow: 0 0 2px #abba55, 0 0 6px #e705f375, 0 0 2px #a805f375 !important;
}
...
.xterm .xterm-scrollable-element > .scrollbar > .slider {
    background: linear-gradient(to bottom, #ff51ff 25%, #2864fc) !important;
    border-radius: 10px;
}
